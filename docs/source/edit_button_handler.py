...
class HTMLButtonAdder:
    ...
    def __overwrite_html(self, file_names: tuple, wiki_prefix: str) -> None:
        ...
        html_str_replace = self._overwrite_kokkosfunction_style(html_string=html_str_replace)
    ...
    @staticmethod
    def _overwrite_kokkosfunction_style(html_string: str) -> str:
        """Overwrites kokkosfunction style."""
        # Overwriting the kokkosfunction style without version
