...
Specific implementation of :doc:`ReducerConcept <ReducerConcept>` storing the minimum value
...
* In order to use Min with a custom type, a template specialization of ``Kokkos::reduction_identity<CustomType>`` must be defined. See :doc:`Built-In Reducers with Custom Scalar Types <../../../ProgrammingGuide/Custom-Reductions-Built-In-Reducers-with-Custom-Scalar-Types>` for details
