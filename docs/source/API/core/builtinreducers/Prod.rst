...
Specific implementation of :doc:`ReducerConcept <ReducerConcept>` performing a ``multiply`` operation
...
* In order to use Prod with a custom type, a template specialization of ``Kokkos::reduction_identity<CustomType>`` must be defined. See :doc:`Built-In Reducers with Custom Scalar Types <../../../ProgrammingGuide/Custom-Reductions-Built-In-Reducers-with-Custom-Scalar-Types>` for details
