...
.. cpp:function:: template<class TeamMemberType, class iType> TeamVectorRange(TeamMemberType team, iType count);
...
.. cpp:function:: template<class TeamMemberType, class iType1, class iType2> TeamVectorRange(TeamMemberType team, iType1 begin, iType2 end);
